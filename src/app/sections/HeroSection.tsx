    ...
    return <section className="flex w-full h-[calc(100vh-5rem)]">
        <div className="w-1/2 bg-[#0f0700] px-10 flex flex-col justify-center">
            ...
            <div className="mt-6 flex flex-col gap-6">
                <h1 className="text-5xl text-white leading-[3.5rem]">Do more than store<br /> with Cloudly</h1>
                ...
                <Link href={"#"} className="text-white underline underline-offset-2 flex gap-3 font-medium">Already have a Cloudly account? Sign up here <ArrowRight className="w-5" /></Link>
            </div>
        </div>
        <div className="w-1/2 relative bg-gradient-to-r from-[#f1f1f1] to-[#e4e4e4]">
            <Image src={HeroImage} width={700} height={700} alt="Hero Image" quality={100} priority  className="absolute right-0 bottom-0" unoptimized />
        </div>
    </section>
}