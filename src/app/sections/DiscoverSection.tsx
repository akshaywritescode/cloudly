...
export default function DiscoverSection() {
    return <section className="py-28 bg-white flex justify-center items-center">
        <div className="py-20 w-[95%] bg-blue-600 rounded-2xl flex flex-col items-center gap-10">
            ...
            <Link href={"/signup"}><Button className="bg-white text-black py-6 text-base lg:py-8 lg:text-xl hover:bg-white/90 hover:cursor-pointer">Learn About Cloudly <ArrowRight /></Button></Link>
        </div>
    </section>
}